...
class SystemPrims extends Primitives {
  ...
  public Object dispatch(int offset, Object[] args, LContext lc){
    switch(offset){
      ...
      case 23: return prim_getProperty(args[0], lc);
      case 24: return null;   // ignore
      case 25: return prim_qsym(args[0], lc);
      case 26: return prim_now(lc);
      case 27: return prim_dateformat(args[0], args[1], args[2], lc);
      case 28: return prim_dateparse(args[0], args[1], lc);
      case 29: System.exit(0); return null;
      case 30: return prim_clarg(args[0], lc);
      case 31: lc.indent = Logo.prs(args[0]); return null;
      case 32: lc.handleLine = Logo.aBoolean(args[0], lc); return null;
      case 33: Logo.base=8; return null;
      case 34: Logo.base=10; return null;
      case 35: return prim_ask(args[0], lc);
      case 36: return lc.answer;
    }
    return null;
  }
