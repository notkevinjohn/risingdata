...
int textoffset;
  ...
  public Object dispatch(int offset, Object[] args, LContext lc){
    ...
    case 29: return prim_logopen(args[0], lc);
    case 30: return prim_logclose(lc);
    }
    return null;
  }
...
//    lc.filename = name;
 ...
 String resourceToString(String filename, LContext lc){
  ...
  Object prim_logopen(Object arg1, LContext lc){lc.logname = Logo.prs(arg1); return null;}
  Object prim_logclose(LContext lc){lc.logname=null; return null;}
