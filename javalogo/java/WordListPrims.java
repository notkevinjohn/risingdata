...
*/
  public Object dispatch(int offset, Object[] args, LContext lc)
  {
    ...
    case 32: return prim_lcase(args[0], lc);
    case 33: return prim_replace(args[0], args[1], args[2], lc);
    case 34: return prim_split(args[0], args[1], lc);
    case 35: return new byte[Logo.anInt(args[0], lc)];
    case 36: return prim_nformat(args[0], args[1], lc);
    case 37: return prim_unzip(args[0], args[1], args[2], args[3], lc);
    }
    return null;
  }
...
*/
  ...
  Object prim_nth(Object arg1, Object arg2, LContext lc) {
    ...
    if (arg2 instanceof byte[]) return new Double(0xff&((byte[])arg2)[pos]);
    if (arg2 instanceof int[]) return new Double(0xffffffffL&((int[])arg2)[pos]);
    if (arg2 instanceof String) return ((String)(arg2)).substring(pos, pos+1);
    return (arg2 instanceof Object[])?
      ((Object[])arg2)[pos]:(Logo.prs(arg2)).substring(pos, pos+1);
  }
  ...
  Object prim_count(Object arg1, LContext lc) {
    if(arg1 instanceof byte[]) return new Double(((byte[])arg1).length);
    if(arg1 instanceof int[]) return new Double(((int[])arg1).length);
    if(arg1 instanceof Object[]) return new Double(((Object[])arg1).length);
    return new Double(Logo.prs(arg1).length());
  }
  ...
  if((arg1 instanceof String) & (arg2 instanceof String))
    new Boolean(((String)arg1).indexOf((String)arg2)>-1);
  ...
  Object prim_setnth(Object arg1, Object arg2, Object arg3, LContext lc) {
    int index = Logo.anInt(arg1, lc);
    if(arg2 instanceof byte[])((byte[])arg2)[index] = (byte)((Number)arg3).intValue();
    else if(arg2 instanceof int[])((int[])arg2)[index] = (int)((Number)arg3).longValue();
    else ((Object[]) Logo.aList(arg2, lc))[index] = arg3;
    return null;
  }
  ...
  Object prim_ascii(Object arg1, LContext lc) {
    return new Double((int)Logo.aString(arg1, lc).charAt(0));
  }
  ...
  Object prim_lcase(Object arg1, LContext lc) {
    return Logo.prs(arg1).toLowerCase();
  }

  Object prim_replace(Object arg1, Object arg2, Object arg3, LContext lc) {
    String text = Logo.prs(arg1);
    String from = Logo.prs(arg2);
    String to = Logo.prs(arg3);
    return text.replaceAll(from, to);
  }

  Object prim_split(Object arg1, Object arg2, LContext lc) {
    String text = Logo.prs(arg1);
    String delim = Logo.prs(arg2);
    return text.split(delim);
  }

  Object prim_nformat(Object arg1, Object arg2, LContext lc) {
    String fstr = Logo.prs(arg1);
    double str = Logo.aDouble(arg2, lc);
    StringWriter sw = new StringWriter();
    PrintWriter pw = new PrintWriter(sw);
    pw.format("%"+fstr+"f", str);
    return sw.toString();
  }

  Object prim_unzip(Object arg1, Object arg2, Object arg3, Object arg4, LContext lc){
    byte[] inbuf = (byte[]) arg1;
    int offset = Logo.anInt(arg2, lc);
    int ilen = Logo.anInt(arg3, lc);
    int olen = Logo.anInt(arg4, lc);
    ByteArrayInputStream is = new ByteArrayInputStream(inbuf, offset, ilen);;
    InflaterInputStream zis = new InflaterInputStream(is);

    byte[] res = new byte[olen];
    try {
      int off = 0;
      int len;
      while(olen > 0){
        len = zis.read(res, off, olen);
//        System.out.println(off+" "+len+" "+olen);
        off+=len; olen-=len;
      }
      return res;
    }
    catch (Exception e) {Logo.error("can't inflate "+e, lc);}
    finally {
      try {
        if(zis!=null) zis.close();
        if(is!=null) is.close();
      } catch (Exception e) {Logo.error("can't close inflater "+e, lc);}
    }
    return null;
  }
